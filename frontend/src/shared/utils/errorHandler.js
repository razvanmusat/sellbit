...
const ERROR_MESSAGES = {
  ...
  "ERROR.FISCAL.NOT_CONNECTED": "Casa de marcat nu este conectată. Nu s-a trimis nicio comandă — verifică conexiunea și încearcă din nou.",
  ...
  "ERROR.FISCAL.POLLING_LOST": "Conexiunea cu casa de marcat s-a pierdut după trimiterea bonului. Verifică dacă bonul a fost tipărit fizic.",
  "ERROR.FISCAL.STILL_PROCESSING": "Bonul anterior este încă în curs de procesare la casa de marcat. Așteaptă câteva secunde și încearcă din nou.",
  "ERROR.FISCAL.PRINT_FAILED_CONFIRMED": "Casa de marcat a confirmat că tipărirea a eșuat. Bonul a revenit pe deschis — încearcă din nou.",
  "ERROR.FISCAL.UNCONFIRMED": "Starea bonului la casă nu poate fi confirmată acum. Reîncearcă în câteva secunde — confirmă manual doar dacă vezi bonul tipărit fizic.",
  "ERROR.FISCAL.DIRECT_NOT_PRINTED": "Casa de marcat nu a tipărit bonul. Încasarea a fost anulată — reia operațiunea.",
