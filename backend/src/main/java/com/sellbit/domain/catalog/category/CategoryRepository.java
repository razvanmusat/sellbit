...
public interface CategoryRepository extends JpaRepository<Category, Integer> {
    ...
    /**
     * * Pasul 1: Obține categoriile principale active (ex: Produse, Meniuri,
     * Servicii).
     ...
     * Esențial pentru DTO (hasChildren) pentru a știi dacă afișăm subcategorii sau
     * produse la click.
     */
    ...
    /**
     * Verifică dacă există orice fel de subcategorie (folosit în logica de
     * business)
     */
    ...
    /**
     * Returnează toate categoriile active ca listă plată (util pentru căutare
     * globală)
     */
     ...
     * Filtrăm să fie ACTIVE și să EXCLUDEM categoria specială 'AVANS'.
     */
