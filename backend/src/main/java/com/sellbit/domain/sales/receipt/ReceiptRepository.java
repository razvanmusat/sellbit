...
public interface ReceiptRepository extends JpaRepository<Receipt, Integer> {
     ...
     */
    List<Receipt> findByWarehouseIdAndStatus_Code(Integer warehouseId, String statusCode);
    ...
    /**
     * JURNAL TOTAL (Audit):
     * Toate mișcările de pe un tab (Gestiune) indiferent dacă sunt CLOSED sau CANCELLED.
     */
